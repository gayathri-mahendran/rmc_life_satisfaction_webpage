...
cantril %>% filter(Year %in% c(2011,2023)) %>% select(-Code) %>%
...
# Create line chart
line_chart <- cantril %>% filter(Country %in% c("Afghanistan",
                                  "Albania",
                                  "Venezuela",
                                  "Ukraine",
                                  "Somalia",
  ...
  ggplot(aes(x = as.factor(Year),
         ...
         text = paste(" Year:",Year,"<br>",
                      "Cantril ladder score:",`Cantril ladder score`,"<br>",
                      "Country:",Country))) +
...
plotly_plot <- ggplotly(line_chart, tooltip = "text")
...
function filter_default() {
  var default_countries = ["Ukraine", "Albania", "Afghanistan", "Somalia", "Laos", "Venezuela"]; // Set default countries here
